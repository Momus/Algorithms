...
*** Programing Assignments
    ...
    #+BEGIN_SRC sh  :results value verbatim
      mvn exec:java -Dexec.mainClass="org.momus.algorithms.PercolationStats"  -Dexec.args="20  400" | grep -v INFO
    #+END_SRC

    #+RESULTS:
    : mean                    = 0.004074999999999947
    : stddev                  = 0.03150000000000037
    : 95% confidence interval = 9.879999999999108E-4, 0.007161999999999983
